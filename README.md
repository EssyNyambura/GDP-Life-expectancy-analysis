...
An inferential statistical analysis on whether GDP determines Life expectancy


# Overview

This is a hypothesis-driven analysis that analyses whether the GDP of a country can be a predictor of Life expectancy. Using a csv
file from Kaggle on Life expectancy (https://www.kaggle.com/datasets/kumarajarshi/life-expectancy-who?resource=download), I applied various statistical methods such as t-test, Confidence interval and pearsons to answer my research questions. Only relevant columns were used in the analysis (Life expectancy, GDP, Status (Developed / Developing), Year (2015).
